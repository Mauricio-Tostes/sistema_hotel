...
class Application(Funcs):
    ...
    def widgets_frame1(self):
        ...
        self.bt_buscar = Button(self.frame_1, text="Buscar", font=("DejaVu Sans Mono", 14, "bold"), bd=3)
        ...
        self.bt_alterar = Button(self.frame_1, text="Alterar", font=("DejaVu Sans Mono", 14, "bold"), bd=3)
